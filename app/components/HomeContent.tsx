...
export default function HomeContent() {
  ...
  return (
    <>
      ...
      <link rel="preconnect" href="https://playbeggar.online" />
      <link rel="dns-prefetch" href="https://playbeggar.online" />
            ...
            <div className="grid md:grid-cols-4 gap-8 mb-12">
              ...
              <div>
                ...
                <ul className="space-y-2 text-gray-400">
                  ...
                  <li><Link href="/how-to-play" className="hover:text-yellow-400 transition-colors">How to Play</Link></li>
                  <li><Link href="/privacy-policy" className="hover:text-yellow-400 transition-colors">Privacy Policy</Link></li>
                  <li><Link href="#download" className="hover:text-yellow-400 transition-colors">Download App</Link></li>
                </ul>
              </div>
